...
public class BulletPlayerGun : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        //CPUNumber + 10 is the lyer of player/or CPU that instantiated thi bullet. >10 is necessary to make sure that bullet does not interact with other layers (Default for example)
